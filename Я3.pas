...
for i in range(10):
    ...
    if player1_value > player2_value:
        print("player 1 wins-->You can see Rick and Morty")
        player1_score = player1_score + 1  # This is how we increment a variable
    elif player2_value > player1_value:
        print("player 2 wins-->You can see Southpark")
    ...
    if player2_value > player3_value:
        print("player 2 wins-->You can see Rick and Morty")
        player2_score = player3_score + 1  # This is how we increment a variable
    elif player3_value > player2_value:
        print("player 3 wins-->You can see Southpark")
        player2_score = player2_score + 1
    else:
        print("It's a draw-->don't watch tv")
    if player4_value > player3_value:
        print("player 4 wins-->You can see Rick and Morty")
